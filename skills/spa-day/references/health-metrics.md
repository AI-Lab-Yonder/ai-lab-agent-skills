...
|-----------|---------|---------|----------|
| CLAUDE.md | <100 lines | 100–200 lines | >200 lines |
...
| Dead references in CLAUDE.md | 0 | Any |
...
A healthy CLAUDE.md is a **lean IF-ELSE directory** pointing to context files:
...
**Flag if**: CLAUDE.md contains >20 lines of inline instructions that could be extracted to a rule file.

## Gotchas Health

| Metric | Healthy | Flag |
|--------|---------|------|
| Entries per gotchas.md | <30 | >30 (suggest `/prune-gotchas`) |
